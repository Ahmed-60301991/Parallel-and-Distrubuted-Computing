...
# #     """
# #     Efficiently calculates total distance of a route using NumPy vectorized operations.

# #     Parameters:
# #         - route (list): The order of nodes visited.
# #         - distance_matrix (numpy.ndarray): The matrix of distances between nodes.

# #     Returns:
# #         - float: The total distance traveled.
# #     """
# #     distances = distance_matrix[route[:-1], route[1:]]  # Vectorized lookup
# #     total_distance = np.sum(distances)
# #     return total_distance if 10000 not in distances else -1e6#Apply penalty for infeasible routes
